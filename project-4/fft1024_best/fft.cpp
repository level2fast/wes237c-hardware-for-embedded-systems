...
{
#pragma HLS INTERFACE m_axi depth=1024 port=OUT_R offset=slave bundle=outputR
#pragma HLS INTERFACE m_axi depth=1024 port=OUT_I offset=slave bundle=outputI
#pragma HLS INTERFACE m_axi depth=1024 port=IN_R offset=slave bundle=inputR
#pragma HLS INTERFACE m_axi depth=1024 port=IN_I offset=slave bundle=inputI
